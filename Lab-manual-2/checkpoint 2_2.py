...
english_frequency = 'etaonhisrdlcufmwgybpvkxjqz'
...
def break_substitution_cipher(cipher):
    ...
    # Map cipher letters to English frequency order
    updated_frequency = list('etaoihsnrdlbufmgwcypvkxxqz')
    mapping = {common_letters[i]: updated_frequency[i] for i in range(len(common_letters))}
...
decrypted_text = break_substitution_cipher(cipher2)
print("Decryption for Cipher 2:\n")
